module.exports = function ( grunt ) {
    ...
    copy: {
      ...
      buildViewerStyles: {
        files: [
          {
            src: ['<%= viewerFiles.css %>'],
            dest: '<%= buildDir %>/plugins/document-viewer',
            cwd: '.',
            expand: true,
            flatten: true,
          }
  ...
  grunt.registerTask( 'build', [
    ...
    'babel', 'copy:buildVendorjs', 'copy:buildVendorcss','copy:buildVendorFonts',
    'copy:buildFonts', 'copy:buildAppPatterns', 'copy:buildThemeStyles', 'copy:buildViewerStyles',
    'copy:buildViewerJs', 'copy:buildIcheckJs',
    'copy:buildCacheManifest', 'index:build'
  ]);
  ...
  grunt.registerTask( 'compile', [
    ...
    'uglify', 'index:compile', 'copy:copyPlugins'
  ]);
